...
write_class_to_file(generate_all_results(bubblesort, "bubblesort", 500, 10001, 1500), "algorithm_time_results/bubblesort")

time_results = ["bubblesort", "insertionsort", "median_of_three_quicksort", "mergesort", "quicksort", "right_pivot_quicksort", "selectionsort", "timsort"]


for i in time_results:
    plot_all_from_file(i)
